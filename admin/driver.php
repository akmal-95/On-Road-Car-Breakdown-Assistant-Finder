...
<body>
    ...
    <ul class="navbar-nav">
      ...
      <li><a href="mechanic.php">Mechanic</a></li>
			...
			<li><a href="driver.php?logout='1'" style="margin-left: 1070px;" >logout</a></li>
    </ul>
  </nav>
  ...
  <div id="side-menu" class="side-nav">
		...
		<a href="driver.php?logout='1'">logout</a>
  </div>
  ...
  <div class="column middle">
		...
		$query = "SELECT * FROM users WHERE user_type = 'driver' ";
