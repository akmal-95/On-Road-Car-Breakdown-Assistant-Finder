...
<body>
	...
	<nav class="navbar">
		...
		<ul class="navbar-nav">
			...
			<li><a href="mechanic.php?logout='1'" style="margin-left: 1070px;" >logout</a></li>
		</ul>
	</nav>
	...
	<div id="side-menu" class="side-nav">
		...
		<a href="mechanic.php?logout='1'">logout</a>
	</div>
  ...
  <div class="column middle">
		<form action="mechanic.php" method="post">
			<?php
		...
		$query = "SELECT * FROM users WHERE user_type = 'mechanic' ";
