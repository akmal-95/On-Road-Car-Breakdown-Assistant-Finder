...
<body>
	...
	<nav class="navbar">
		...
		<ul class="navbar-nav">
			...
			<li><a href="addadmin.php?logout='1'" style="margin-left: 1070px;" >logout</a></li>
		</ul>
	</nav>
	...
	<div id="side-menu" class="side-nav">
		...
		<a href="addadmin.php?logout='1'">logout</a>
	</div>
  ...
  <div class="column middle">
		<form method="post" action="addadmin.php">
			...
			<div class="input-group">
				<button type="submit" class="btn" name="register_btn">ADD NEW ADMIN</button>
			</div>
		</form>
	</div>
  <div class="column side">
