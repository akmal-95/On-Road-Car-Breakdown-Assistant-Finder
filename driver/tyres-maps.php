...
<body>
	<div class="header">
		<h2>Driver - Request Tyres Page</h2>
	</div>
	<div class="content">
	...
	<div class="column middle">
		<form>
				...
				<script>
						...
						var requested = <?php get_confirmed_tyres_requested() ?>;
						var myOptions = {
								zoom: 15,
						...
						var addMarker = google.maps.event.addListener(map, 'click', function(e) {
								...
								var marker = new google.maps.Marker({
										...
										"         	  <td><input type='text'  id='service_type' value='tyres' hidden></textarea></td></tr>\n" +
						...
						function saveData(lat,lng) {
								...
								var url = '../function/functions.php?add_tyres_location&description=' + description + '&lat=' + lat + '&lng=' + lng + '&service_type=' + service_type + '&username=' + username + '&firstname=' + firstname + '&lastname=' + lastname + '&phonenumber=' + phonenumber;
								downloadUrl(url, function(data, responseCode) {
										if (responseCode === 200  && data.length > 1) {
