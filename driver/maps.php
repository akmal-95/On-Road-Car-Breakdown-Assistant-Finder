	...
	<div class="column middle">
		<form>
				...
				<script>
						...
						var requested = <?php get_confirmed_requested() ?>;
						var myOptions = {
								zoom: 15,
						...
						for (i = 0; i < requested.length; i++) {
								marker = new google.maps.Marker({
										...
										"<table class=\"map1\">\n" +
										"<tr>\n" +
										"<td><textarea disabled id='workshopname' placeholder='Description'>"+requested[i][5]+"</textarea></td></tr>\n" +
										"<td><textarea disabled id='phonenumber' placeholder='Description'>"+requested[i][6]+"</textarea></td></tr>\n" +
										"<td><textarea disabled id='manual_description' placeholder='Description'>"+requested[i][3]+"</textarea></td></tr>\n" +
										" <tr><td><input type='button' value='Route' onclick='route("+requested[i][1]+","+requested[i][2]+")'/></td></tr>\n" +
										"</table>\n" +
										"</div>"
								});
						...
						function saveData(lat,lng) {
								...
								var url = '../function/functions.php?add_location&description=' + description + '&lat=' + lat + '&lng=' + lng;
