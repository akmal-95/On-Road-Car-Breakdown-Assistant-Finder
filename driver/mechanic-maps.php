...
<body>
	<div class="header">
		<h2>Driver - Request Mechanic Page</h2>
	</div>
	<div class="content">
	...
	<div class="column middle">
		<form>
				...
				<script>
						...
						var requested = <?php get_confirmed_mechanic_requested() ?>;
						var myOptions = {
								zoom: 15,
						...
						var addMarker = google.maps.event.addListener(map, 'click', function(e) {
								...
								var marker = new google.maps.Marker({
										...
										"         	  <td><input type='text'  id='service_type' value='mechanic' hidden></textarea></td></tr>\n" +
										...
										"            <tr><td></td><td><input type='button' class=btn value='Save' onclick='saveData("+lat+","+lng+")'/></td></tr>\n" +
										"        </table>\n" +
										"    </div>"
								});
						...
						function saveData(lat,lng) {
								...
								var url = '../function/functions.php?add_mechanic_location&description=' + description + '&lat=' + lat + '&lng=' + lng + '&service_type=' + service_type + '&username=' + username + '&firstname=' + firstname + '&lastname=' + lastname + '&phonenumber=' + phonenumber;
								downloadUrl(url, function(data, responseCode) {
										if (responseCode === 200  && data.length > 1) {
