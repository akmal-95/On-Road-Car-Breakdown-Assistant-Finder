...
<body>
	<div class="header">
		<h2>Driver - Request Battery Page</h2>
	</div>
	<div class="content">
	...
	<div class="column middle">
		<form>
				...
				<script>
						...
						var requested = <?php get_confirmed_battery_requested() ?>;
						var myOptions = {
								zoom: 15,
						...
						var addMarker = google.maps.event.addListener(map, 'click', function(e) {
								...
								var marker = new google.maps.Marker({
										...
										"         	  <td><input type='text'  id='service_type' value='battery' hidden></textarea></td></tr>\n" +
						 ...
						 function saveReq() {
							 ...
							 downloadUrl(url, function(data, responseCode) {
									if (responseCode === 200  && data.length > 1) {
											...
											infowindow.setContent("<div style='color: blue; font-size: 25px;'>Inserting SUccess</div>");
									}else{
						...
						function saveData(lat,lng) {
								...
								var url = '../function/functions.php?add_battery_location&description=' + description + '&lat=' + lat + '&lng=' + lng + '&service_type=' + service_type + '&username=' + username + '&firstname=' + firstname + '&lastname=' + lastname + '&phonenumber=' + phonenumber;
								downloadUrl(url, function(data, responseCode) {
										if (responseCode === 200  && data.length > 1) {
