...
<body>
	...
	<div id="main">
		...
		<form method="post" action="mhome.php">
			...
			<div class="input-group">
				<button style="margin-left:auto;margin-right:auto;display:block;margin-top:5%;margin-bottom:0%" type="submit" class="btn" name="mupdate_btn">UPDATE</button>
